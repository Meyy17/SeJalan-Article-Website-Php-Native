...
<html>
  <head>
    ...
    <title>Upload Content | Admin SeJalan</title>
    ...
    <div class="row flex-nowrap">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul" id="exampleInputEmail1"  required >
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="video" id="exampleInputEmail1"  required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="short_desc" required maxlength="177"></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Lokasi</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="lokasi" required maxlength="177"></textarea>
                    </div>
                   
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Subtitle</label>
                        <input type="text" class="form-control" name="subtitle" id="exampleInputEmail1" maxlength="100"  required >
                    </div>

                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 1</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p1"  required></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 2</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p2" ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 3</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p3" ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 4</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p4"  ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 5</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p5"  ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 6</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p6" ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 7</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p7" ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 8</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p8"  ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 9</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p9" ></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Content Paragraft 10</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" name="desc_p10" ></textarea>
                    </div>
  ...
  <?php 
    if(isset($_POST['btnsubmit'])){
      ...
      elseif(!in_array($type2vid, $typevid)){
        echo "<script>alert('Format Video Tidak Sesuai')</script>";
      }
      else{
        if($kategori != ""){
            ...
            $insert = mysqli_query($conn, "INSERT INTO content (judul, image, video, short_desc, lokasi, subtitle, desc_p1, desc_p2, desc_p3, desc_p4, desc_p5, desc_p6, desc_p7, desc_p8, desc_p9, desc_p10, kategori, tanggal_upload) VALUES (
                '".$judul."', 'Image/".$filename."', 'Video/".$videoname."', '".$short_desc."', '".$lokasi."', '".$subtitle."','".$desc_p1."','".$desc_p2."', '".$desc_p3."', '".$desc_p4."', '".$desc_p5."', '".$desc_p6."', '".$desc_p7."', '".$desc_p8."', '".$desc_p9."', '".$desc_p10."', '".$kategori."','".$now."'
            )");
