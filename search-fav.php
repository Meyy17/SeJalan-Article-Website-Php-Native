...
<html>
  <head>
    ...
    <title><?php echo $_GET['search'] ?> | SeJalan</title>
        ...
        <div class="wrapper-content-2">
                <form action="search-fav.php">
                        <div class="box">
                            ...
                            <input type="text" placeholder="Cari tempat wisata, kuliner, event" name="search" value="<?php echo $_GET['search'] ?>">
        ...
        <div class="container-head">
                    <?php $index = 1;
                            if($_GET['search'] != ''){
                                ...
                                echo "<script>window.location='favoriteScreen.php'</script>";  
                            }
                            $popular = mysqli_query($conn, "SELECT * FROM favorite_content WHERE $where");
