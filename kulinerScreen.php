  ...
  <body>
    ...
    <header class="d-flex flex-wrap justify-content-center py-3 border-bottom" id="navbar">
        ...
        <div class="wrappertabbar">
            <div class="tabbar">
                <a href="explorescreen.php" class="btnt">Wisata</a>
                <a href="kulinerScreen.php" class="btnt-a">Kuliner</a>
        ...
        <div class="wrapper-body">
            <div class="content">
                <?php $index = 1;
                        $popular = mysqli_query($conn, "SELECT * FROM content WHERE kategori = 'kuliner'");
